    ...
    <div class="centents">
      ...
      <ol type="I" start="1">
        ...
        <li>
          ...
          <p>
            You agree to indemnify and hold harmless Free Code Camp, its contractors, and its licensors, and their respective directors, officers, employees, and agents from and against any and all claims and expenses, including attorneys’ fees, arising out of your use of our Services, including but not limited to your violation of this Agreement.nd their reasonable control. The foregoing shall not apply to the extent prohibited by applicable law.
          </p>
        </li>
        <li>
          <h3>Translation. </h3>
        ...
        <li>
          ...
          <p>
            ...
            <p>These terms are adopted from the Automattic (WordPress) open source terms and are subject to the Creative Commons Attribution-ShareAlike 4.0 International license. We thank them for making this available.</p>
          </p>
        </li>
      </ol>
    </div>
